...
class Add_customer:
    ...
    def screenshot_fail(self):
        self.driver.save_screenshot("..\\screenshots\\add_customer\\test_add_customer_003_fail.png")

    def screenshot_pass_con(self):
        self.driver.save_screenshot("..\\screenshots\\add_customer_confirmation\\test_add_customer_003_pass.png")

    def screenshot_fail_con(self):
        self.driver.save_screenshot("..\\screenshots\\add_customer_confirmation\\test_add_customer_003_fail.png")
